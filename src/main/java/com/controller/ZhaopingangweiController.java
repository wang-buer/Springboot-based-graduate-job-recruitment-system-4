...
public class ZhaopingangweiController {
    ...
    public R list( ZhaopingangweiEntity zhaopingangwei){
       	EntityWrapper<ZhaopingangweiEntity> ew = new EntityWrapper<ZhaopingangweiEntity>();
      	ew.allEq(MPUtil.allEQMapPre( zhaopingangwei, "zhaopingangwei")); 
        return R.ok().put("data", zhaopingangweiService.selectListView(ew));
    }
    ...
    public R query(ZhaopingangweiEntity zhaopingangwei){
        EntityWrapper< ZhaopingangweiEntity> ew = new EntityWrapper< ZhaopingangweiEntity>();
 		ew.allEq(MPUtil.allEQMapPre( zhaopingangwei, "zhaopingangwei")); 
		ZhaopingangweiView zhaopingangweiView =  zhaopingangweiService.selectView(ew);
		return R.ok("查询招聘岗位成功").put("data", zhaopingangweiView);
    }
    ...
    public R info(@PathVariable("id") String id){
		...
		zhaopingangwei.setClicknum(zhaopingangwei.getClicknum()+1);
		zhaopingangwei.setClicktime(new Date());
		zhaopingangweiService.updateById(zhaopingangwei);
        return R.ok().put("data", zhaopingangwei);
    }
    ...
    public R save(@RequestBody ZhaopingangweiEntity zhaopingangwei, HttpServletRequest request){
    	zhaopingangwei.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(zhaopingangwei);
     ...
     */
    @RequestMapping("/add")
    public R add(@RequestBody ZhaopingangweiEntity zhaopingangwei, HttpServletRequest request){
    	zhaopingangwei.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(zhaopingangwei);
        zhaopingangweiService.insert(zhaopingangwei);
        return R.ok();
    ...
    public R update(@RequestBody ZhaopingangweiEntity zhaopingangwei, HttpServletRequest request){
        //ValidatorUtils.validateEntity(zhaopingangwei);
        zhaopingangweiService.updateById(zhaopingangwei);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZhaopingangweiEntity> wrapper = new EntityWrapper<ZhaopingangweiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = zhaopingangweiService.selectCount(wrapper);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ZhaopingangweiEntity zhaopingangwei, HttpServletRequest request,String pre){
        EntityWrapper<ZhaopingangweiEntity> ew = new EntityWrapper<ZhaopingangweiEntity>();
